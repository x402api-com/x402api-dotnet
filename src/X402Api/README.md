...
additionalProperties:
  packageGuid: '5D841236-834E-4E6B-A9F6-B6E12C38AE6B'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAssetsAndPaymentControlsApi>();
            IV1PaymentReadinessRetrieveApiResponse apiResponse = await api.V1PaymentReadinessRetrieveAsync("todo");
            PaymentReadiness? model = apiResponse.Ok();
        }

        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
          .ConfigureX402Api((context, options) =>
          {
              ...
              options.AddX402ApiHttpClients(client =>
              {
...
## Api Information
- appName: x402api Public API
- appVersion: 0.1.0
- appDescription: Public External-Wallet x402 integration endpoints for programmatic charges, readiness, receiving addresses, resources, payments, receipts, and facilitator discovery.
